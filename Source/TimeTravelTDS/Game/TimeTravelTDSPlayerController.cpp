...
void ATimeTravelTDSPlayerController::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void ATimeTravelTDSPlayerController::MoveToMouseCursor()
{
	if (UHeadMountedDisplayFunctionLibrary::IsHeadMountedDisplayEnabled())
	{
		if (ATimeTravelTDSCharacter* MyPawn = Cast<ATimeTravelTDSCharacter>(GetPawn()))
		{
...
void ATimeTravelTDSPlayerController::MoveToTouchLocation(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void ATimeTravelTDSPlayerController::SetNewMoveDestination(const FVector DestLocation)
{
...
void ATimeTravelTDSPlayerController::OnSetDestinationPressed()
{
	// set flag to keep updating destination until released
	bMoveToMouseCursor = true;
}

void ATimeTravelTDSPlayerController::OnSetDestinationReleased()
{
